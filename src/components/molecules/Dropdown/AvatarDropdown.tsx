...
function AvatarDropdown({
  ...
  return (
    <div css={[tw`flex flex-col items-end w-16 md:w-24 h-8 sm:h-12`]}>
      <div
      ...
      >
        <div
          css={[
            tw`flex items-center rounded-full block overflow-hidden w-10 h-8 sm:w-24 md:w-16 md:h-12 mr-1`,
          ]}
        >
